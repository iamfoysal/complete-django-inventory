...
class Blog(models.Model):
    ...
    slug = models.SlugField(max_length=256,
                            ...
                            null=False,
                            blank=False)
    thumbnail = models.ImageField(upload_to='content/blog/thumbnail/',
...
class Videocast(models.Model):
    ...
    slug = models.SlugField(max_length=256,
                            ...
                            null=False,
                            blank=False)
    thumbnail = models.ImageField(upload_to='content/video/thumbnail/',
                                  verbose_name=_('Thumbnail :'))
    publish = models.BooleanField(verbose_name=_('Publish :'),
                                  default=True,
...
class Podcast(models.Model):
    ...
    slug = models.SlugField(max_length=256,
                            ...
                            null=False,
                            blank=False)
    thumbnail = models.ImageField(upload_to='content/podcast/thumbnail/',
                                  verbose_name=_('Thumbnail :'))
    publish = models.BooleanField(verbose_name=_('Publish :'),
                                  default=True,
                                  help_text=_('Will this audio be published?'))
    audio = models.FileField(upload_to='content/podcast/audio/',
